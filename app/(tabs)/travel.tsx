    ...
    >
      <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="items-center mb-8">
          ...
          <Text className="text-gray-500 mt-2 text-sm">Simplify Your Work Life</Text>
        </View>
        ...
        {trip?.tickets.map((ticket, index) => (
          <View key={ticket.id} className="bg-white rounded-2xl p-5 mb-4 shadow-sm border border-gray-100 flex-row items-center">
        ...
        {trip?.accommodations.map((hotel) => (
          <View key={hotel.id} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 mb-6">
            <View className="p-5 flex-row items-center">
              ...
              <View className="flex-1">
                ...
                <Text className="text-gray-400 text-xs">移動 (Accommodation)</Text>
              </View>
            </View>
