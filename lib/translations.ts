export const translations = {
  en: {
    ...
    chat_group_label: "Chat group",
    chat_with_label: "Chat with",
    chat_direct_fallback_name: "Direct chat",
    chat_group_fallback_name: "Group chat",
    tap_for_info: "Tap for info",
    add_attachment: "Add attachment",
    message_input_label: "Message input field",
    ...
    receipt: "Receipt",
    no_receipt_attached: "No receipt attached",
    ...
    brand_name: "ShiftSync",
    brand_region: "JAPAN",
    app_version_label: "ShiftSync Japan v1.0",
    email_placeholder: "name@company.com",
    password_placeholder: "••••••••",
    email_input_label: "Email address input",
    password_input_label: "Password input",
    confirm_password_input_label: "Confirm password input",
    ...
    login_network_error: "Unable to reach Supabase. Check your internet connection and Supabase project status.",
    ...
    onboarding_footer: "ShiftSync Japan • Optimized for efficiency",
    ...
    invite_code_placeholder: "XYZ123",
    invite_code_missing: "-----",
    ...
    manage_shift_title: "Manage Shift",
    manage_shift_msg: "Choose an action",
  ...
  ja: {
    ...
    chat_group_label: "グループチャット",
    chat_with_label: "チャット相手",
    chat_direct_fallback_name: "個別チャット",
    chat_group_fallback_name: "グループチャット",
    tap_for_info: "詳細を見る",
    add_attachment: "添付を追加",
    message_input_label: "メッセージ入力欄",
    send_message: "送信",
    new_chat: "新規チャット",
    create_group: "グループ作成",
    group_name: "グループ名",
    ...
    email_placeholder: "name@company.com",
    password_placeholder: "••••••••",
    email_input_label: "メールアドレス入力",
    password_input_label: "パスワード入力",
    confirm_password_input_label: "パスワード確認入力",
    ...
    sign_up_link: "登録",
    sign_in_link: "ログイン",
    login_network_error: "Supabaseに接続できません。インターネット接続とSupabaseプロジェクトの状態を確認してください。",
    ...
    onboarding_footer: "ShiftSync Japan • 効率化のために最適化",
    ...
    manage_shift_title: "シフト管理",
    manage_shift_msg: "操作を選択してください",
    event_fallback: "イベント",
